...
<div class="containe-fluid" >
	...
	<div class="row mt-3 ml-3 mr-3" >
			<div class="col-lg-12" >
			<div class="card" style="background-color: #05fde9;color: black;font-size: 20px;">
				<div class="card-body" >
				...
				<div class="col-md-3">
                        <div class="card bg-primary text-white mb-3 grow">
                            <div class="card-body ">
                ...
                <div class="col-md-3">
                        <div class="card bg-success text-white mb-3 grow">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                  ...
                  <div class="col-md-3">
                        <div class="card bg-warning text-white mb-3 grow">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                     ...
                     <div class="col-md-3">
                        <div class="card bg-info text-white mb-3 grow">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
